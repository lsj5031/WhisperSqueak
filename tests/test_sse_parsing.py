...
from sse_parser import SSEParser, parse_sse_line
...
class TestSSELineParsing:
    ...
    def test_json_with_other_fields(self):
        ...
        result = parse_sse_line('data: {"data": "text", "timestamp": 123, "confidence": 0.95}', "")
...
class TestEdgeCases:
    ...
    def test_special_json_characters(self):
        ...
        result = parse_sse_line(r'data: {"data": "He said \"hello\""}', "")
    ...
    def test_json_with_nested_objects(self):
        ...
        result = parse_sse_line('data: {"data": "text", "metadata": {"nested": true}}', "")
        assert result.accumulated_text == "text"
